...
set envConfigFile=CodeProject.SenseAI.config
...
echo    "CPSENSEAI_COMFIG"      : "!CPSENSEAI_COMFIG!",
...
echo set CPSENSEAI_ROOTDIR=!CPSENSEAI_ROOTDIR!
...
echo set CPSENSEAI_COMFIG=!CPSENSEAI_COMFIG!
