...
jetson_jetpack()
{
    ...
    case $JETSON_L4T in
        ...
        "32.2.3") JETSON_JETPACK="4.2.3" ;;     # NVIDIA docs incorrect for this one
...
JETSON_JETPACK_MAJOR_MINOR=$(echo "$JETSON_JETPACK" | cut -d'.' -f1,2)
export JETSON_JETPACK_MAJOR_MINOR
