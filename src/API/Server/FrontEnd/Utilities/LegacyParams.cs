...
namespace CodeProject.AI.API.Server.Frontend
{
    ...
    public class LegacyParams
    {
        ...
        /// ModuleRunner.CreateProcessStartInfo. The values that CreateProcessStartInfo
        ...
        /// }
        ///</example>
        /// <para>This method only recieves the "Global" section, not the modules section.</para>
        /// <para>Each value in the Global section is hardcode-mapped to mmodule-specific values
        ...
        /// udpated settings without needing to reload settings, and we also update the
