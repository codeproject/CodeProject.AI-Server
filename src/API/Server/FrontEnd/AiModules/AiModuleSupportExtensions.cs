...
namespace CodeProject.AI.API.Server.Frontend
{
    ...
    /// </summary>
    public static class AiModuleSupportExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static IServiceCollection AddAiModuleSupport(this IServiceCollection services,
                                                            IConfiguration configuration)
        {
            ...
            services.AddSingleton<AiModuleInstaller, AiModuleInstaller>();
            ...
            // Add the runner
            services.AddHostedService<AiModuleRunner>();
