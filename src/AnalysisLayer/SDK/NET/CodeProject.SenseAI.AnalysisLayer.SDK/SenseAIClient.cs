...
{
    public class SenseAIClient
    {
        private static HttpClient? _httpClient;
        public SenseAIClient(string url, TimeSpan timeout = default)
        {
        ...
        /// <summary>
        /// Get a request from the SenseAI Server queue.
        /// </summary>
                                                      ...
                                                      CancellationToken token = default)
        {
            ...
            var httpResponse = await _httpClient!.GetAsync($"v1/queue/{queueName}?moduleid={moduleId}", token)
        ...
        /// <summary>
        /// Sends a response for a request to the SenseAI Server.
        /// </summary>
        ...
        {
            await _httpClient!.PostAsync($"v1/queue/{reqid}?moduleid={moduleId}", content, token)
                             .ConfigureAwait(false);
        }

        /// <summary>
        /// Logs a message to the SenseAI Server.
        /// </summary>
