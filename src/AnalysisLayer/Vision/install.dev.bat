...
call "%installBasePath%\utils.bat" InstallPythonPackages 3.7 "%modulePath%" "torch"

:: Download the YOLO models and store in /assets
call "%installBasePath%\utils.bat" GetFromServer "models.zip" "assets" "Downloading YOLO models..."
