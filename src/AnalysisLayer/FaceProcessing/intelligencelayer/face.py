...
def detect_face(_: CodeProjectAIRunner, data: AIRequestData) -> JSON:
    ...
    try:
        ...
        output = {"success": True, "predictions": outputs, "inferenceMs": inferenceMs}
...
def register_face(module_runner: CodeProjectAIRunner, data: AIRequestData) -> Tuple[JSON, int]:
    ...
    try:
        ...
        if batch is not None:
            ...
            output = {"success": True, "message": message, "inferenceMs": inferenceMs}
...
def recognise_face(_: CodeProjectAIRunner, data: AIRequestData) -> JSON:
    ...
    try:
        ...
        if found_face == False:
            ...
            output = {"success": True, "predictions": predictions, "message": "No known faces", "inferenceMs": inferenceMs}
            ...
            if found_known:
                output = {"success": True, "predictions": predictions, "message": "A face was recognised", "inferenceMs": inferenceMs}
            else:
                output = {"success": True, "predictions": predictions, "message": "No known faces", "inferenceMs": inferenceMs}
