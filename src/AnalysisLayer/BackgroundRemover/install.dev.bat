...
call "%installBasePath%\utils.bat" InstallPythonPackages 3.9 "%modulePath%" "onnxruntime"
...
call "%installBasePath%\utils.bat" GetFromServer "rembg-models.zip" "models" "Downloading Background Remover models..."
