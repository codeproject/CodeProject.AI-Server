...
call "%sdkScriptsPath%\utils.bat" InstallPythonPackages 3.7 "%modulePath%"

:: Download the YOLO models and custom models and store in /assets
call "%sdkScriptsPath%\utils.bat" GetFromServer "models-yolo5-pt.zip"        "assets" "Downloading Standard YOLO models..."

:: TODO: Move this to %ProgramData%\CodeProject\AI\custom-models
call "%sdkScriptsPath%\utils.bat" GetFromServer "custom-models-yolo5-pt.zip" "custom-models" "Downloading Custom YOLO models..."
