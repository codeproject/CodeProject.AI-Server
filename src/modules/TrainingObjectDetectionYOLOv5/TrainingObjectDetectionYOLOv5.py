# print("============= Starting TrainingObjectDetectionYOLOv5 module =============")
...
class YoloV5Trainer_adaptor(ModuleRunner):
    ...
    def get_model_info(self, data: RequestData) -> any:
        ...
        model_created  = model_info_valid and os.path.exists(results_graph_path)
    ...
    def get_dataset_info(self, data: RequestData) -> any:
        ...
        dataset_created = fo.dataset_exists(dataset_name)
        # dataset_created = dataset_size > 0
